...
int loadVertexArrayObjectForNGon(int n , float initialRotation = 0.0f){
    
    float vertices[(n+1)*3];
    setVerticesForNGonWithRadius(vertices, n, 0.75f , initialRotation);
...
int main() {
    ...
    do{
        ...
        unsigned int VAO = loadVertexArrayObjectForNGon(vertexCnt , rotation);
